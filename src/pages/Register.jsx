  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="mt-10 mb-6 text-center">
        ...
        <p className="text-xl text-gray-600">Start your organic farming journey today</p>
      </div>
      ...
      <div className="bg-white shadow-md rounded-xl w-full max-w-2xl p-8 space-y-6">
        <div className="text-center">
          ...
          <p className="text-l text-gray-500">Join Farm Master and unlock your land's potential</p>
        </div>
